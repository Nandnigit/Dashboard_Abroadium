        ...
        <div className="flex  h-16">
          ...
          <div className="flex items-center">
            ...
            <input type='search' className=' px-2 py-2 w-72 rounded-full bg-slate-500 text-slate-300' placeholder=' Enter ' />
              ...
              <Link to="/" className="text-white hover:text-yellow-500 px-3 py-2 rounded-md text-lg font-semibold flex items-center align-middle justify-center gap-1 ">Resume Score <div className=' border-2 w-6 h-6 items-center align-middle justify-center rounded-full'></div></Link>

...
const images = [
  {title:"Welcome to Abroadium’s Futuristic & AI Enabled Dashboard"},
...
const ImageSlider = () => {
  ...
  return (
    <>
      <div className="relative flex justify-center items-center w-full md:w-[100%] h-64 md:h-[100px] mx-auto">
        {/* <FaArrowLeft
        ...
        <div className="slider-container ">
          {images.map((image, index) => (
            ...
            >
              <div className="w-full h-full rounded-3xl text-center text-2xl font-bold" > {image.title} </div>
            </div>
          ))}
        </div>
